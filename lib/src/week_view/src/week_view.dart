...
import 'package:calendar_view/src/model/model.dart';
import 'package:calendar_view/src/week_view/src/internal_week_view_page.dart';
import 'package:calendar_view/src/week_view/src/week_view_header.dart';
...
class WeekView<T extends Object?> extends StatefulWidget {
  ...
  @override
  State createState() => WeekViewState<T>();
}
...
class WeekViewState<T extends Object?> extends State<WeekView<T>> {
  ...
  /// Scroll controller for week view.
