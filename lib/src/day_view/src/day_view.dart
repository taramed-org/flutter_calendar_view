...
import 'package:calendar_view/src/day_view/src/day_page_header.dart';
import 'package:calendar_view/src/day_view/src/default_timeline_mark.dart';
import 'package:calendar_view/src/day_view/src/internal_day_view_page.dart';
import 'package:calendar_view/src/day_view/src/whole_day_event_view.dart';
import 'package:flutter/material.dart';

/// {@template day_view}
/// A main widget for day view.
/// {@endtemplate}
class DayView<T extends Object?> extends StatefulWidget {
  ...
  const DayView({
    ...
    super.key,
        ...
        assert(
          heightPerMinute > 0,
          'Height per minute must be greater than 0.',
        ),
        assert(
...
If you use [dayPressDetectorBuilder]
  ...
  /// If true this will display half hour lines in day view.
  ...
  @override
  DayViewState createState() => DayViewState<T>();
}
...
class DayViewState<T extends Object?> extends State<DayView<T>> {
  ...
  Widget _defaultFullDayEventBuilder(
    ...
    DateTime date,
      ...
      WholeDayEventView(events: events, date: date);
